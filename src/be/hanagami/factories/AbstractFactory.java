...
class Tea implements IHotDrink
{
    ...
    public void consume()
    {
        System.out.println("this tea is nice but I's prefer it with milk");
    }
}
...
//            Class<?> factory = Class.forName("be.hanagami.factories." + factoryName + "Factory");
...
//        }
        ...
        Set<Class<? extends IHotDrinkFactory>> types
                = new Reflections("be.hanagami.factories.") //""
